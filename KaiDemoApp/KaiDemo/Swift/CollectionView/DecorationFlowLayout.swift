...
class DecorationFlowLayout : UICollectionViewFlowLayout {
    ...
    override init() {
        super.init()
        self.register(BookShelfDecorationView.self, forDecorationViewOfKind: "BookShelfDecorationView")
    }
    ...
    override func prepare() {
        ...
        for section in 0..<numberOfSections {
            ...
            // 2.5 计算装饰图属性
            let decorations = UICollectionViewLayoutAttributes(forDecorationViewOfKind: "BookShelfDecorationView", with: IndexPath(item: 0, section: section))
...
//
//        if elementKind == "BookShelfDecorationView" {
//            attributes?.frame = sectionAttrs[indexPath.section].frame
//        }
//        return attributes
//    }
